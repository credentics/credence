...
class UpdateDocument
    implements UseCase<DocumentDetailEntity, UpdateDocumentParams> {
  UpdateDocument(this._repository);

  final DocumentRepository _repository;

  @override
  Future<DocumentDetailEntity> call(UpdateDocumentParams params) {
